...
<head>
    ...
    <title>Listado de Categorías de Producto</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        <h1>Listado de Categorías de Producto</h1>
        <p class="subtitle">{{ $product_categories->count() }} registro{{ $product_categories->count() == 1 ? '' : 's' }}</p>
