                    ...
                    @foreach ($service_categories as $service_categorie) 
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            <th scope="row" class="px-3 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{$service_categorie->id}}
                            </th>
                            <td class="px-3 py-2">
                                {{$service_categorie->name}}
                            </td>  
                            ...
                            <td class="px-3 py-2" >
                                <div class="flex space-x-2">
                                    ...
                                    <a href="{{route('admin.service_categories.edit', $service_categorie)}}" class="btn btn-blue text-xs">Editar</a>
                                    <form class="delete-form" action="{{route('admin.service_categories.destroy', $service_categorie)}}" method="POST">
                                    ...
                                    <a href="{{ route('admin.service_categories.pdf', $service_categorie->id) }}" class="btn btn-orange text-xs" target="_blank">PDF</a>
