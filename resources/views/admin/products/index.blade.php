    ...
    <div class="flex flex-wrap justify-between items-center gap-3 mb-6">
        ...
        <div class="">
            @can('admin.products.pdf')
                <a href="{{ route('admin.products.pdf') }}" class="btn btn-orange" target="_blank">
                    <i class="fa-solid fa-file-pdf mr-1"></i> PDF
                </a>
                <a href="{{ route('admin.products.excel') }}" class="btn btn-green">
        ...
        <form method="GET" action="{{ route('admin.products.index') }}" class="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div class="relative flex-1 sm:min-w-[220px]">
                ...
                <input type="text" name="search" value="{{ request('search') }}"
                    class="input-label rounded-lg w-full" placeholder="Buscar por producto o categoría">
            </div>
            <div class="flex items-center gap-2 shrink-0">
                ...
                @if (request('search'))
                    <a href="{{ route('admin.products.index') }}" class="btn btn-gray rounded-lg text-sm whitespace-nowrap">
