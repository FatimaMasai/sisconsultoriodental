<x-admin-layout>
    ...
    <form action="{{ route('admin.suppliers.store') }}" method="POST" id="supplier-form">
        @csrf
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 mb-6">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div>
                    ...
                    <x-input value="{{ old('company') }}" name="company" class="input-label rounded-lg w-full" placeholder="Bagó" />
                </div>
                <div>
                    <x-label class="form-label">NIT <span class="text-red-500">*</span></x-label>
                    <x-input value="{{ old('nit') }}" name="nit" type="text" inputmode="numeric" class="input-label rounded-lg w-full" placeholder="Ingrese el NIT" />
                </div>
            </div>
        </div>
