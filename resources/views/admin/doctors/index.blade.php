<x-admin-layout>
    <div class="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between mb-6">
        ...
        <div class="flex flex-wrap items-center gap-2">
            @can('admin.doctors.pdf')
                <a href="{{ route('admin.doctors.pdf') }}" class="btn btn-orange" target="_blank">
                    <i class="fa-solid fa-file-pdf mr-1"></i> PDF
                </a>
                <a href="{{ route('admin.doctors.excel') }}" class="btn btn-green">
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 mb-6">
        <form method="GET" action="{{ route('admin.doctors.index') }}" class="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <div class="flex items-center gap-2 shrink-0">
                ...
                @if (request('search'))
                    <a href="{{ route('admin.doctors.index') }}" class="btn btn-gray rounded-lg text-sm whitespace-nowrap">
    ...
    @else
        ...
        <div class="flex items-center p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
            ...
            <div>
                ...
                @else
                    Todavia no hay doctores registrados.
                @endif
            </div>
        </div>
