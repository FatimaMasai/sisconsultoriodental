        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 mb-6">
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <div>
                    ...
                    <x-input value="{{ old('name') }}" name="name" class="input-label rounded-lg w-full"
                        placeholder="Lupita" required />
                </div>
                <div>
                    <x-label class="form-label">Apellido Paterno <span class="text-red-500">*</span></x-label>
                    <x-input value="{{ old('last_name_father') }}" name="last_name_father" class="input-label rounded-lg w-full"
                        placeholder="Cuellar" required />
                </div>
                <div>
                    <x-label class="form-label">Apellido Materno <span class="text-red-500">*</span></x-label>
                    <x-input value="{{ old('last_name_mother') }}" name="last_name_mother" class="input-label rounded-lg w-full"
                        placeholder="Paz" required />
                </div>
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <x-input value="{{ old('phone') }}" name="phone" type="tel"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <x-input value="{{ old('email') }}" name="email" type="email"
