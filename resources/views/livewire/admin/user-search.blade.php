<div>
    ...
    <x-input wire:model.live="search" class="form-control w-full" placeholder="Buscar por nombre o email" />
    ...
    @else
        ...
        <div class="flex items-center p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
            ...
            <div>
                <span class="font-medium">Info alert!</span> <U></U>Usuario no encontrado.
            </div>
        </div> 
